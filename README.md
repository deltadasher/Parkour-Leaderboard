...
- click-to-open player profile cards with data-derived archive bios, board placements, per-item reviews, notes, and archived forum activity for any listed player;
